...
DomainErrorTranslator._directories = {
  ...
  "ADDED_THREAD.NOT_CONTAIN_NEEDED_PROPERTY": new InvariantError("gagal menambahkan thread"),
  "ADDED_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION": new InvariantError("gagal menambahkan thread"),

  "ADDED_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY": new InvariantError("gagal menambahkan komentar"),
  "ADDED_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION": new InvariantError("gagal menambahkan komentar"),

  "DELETE_COMMENT_USE_CASE.NOT_CONTAIN_NEEDED_PROPERTY": new InvariantError("parameter hapus komentar tidak lengkap"),
  "DELETE_COMMENT_USE_CASE.NOT_MEET_DATA_TYPE_SPECIFICATION": new InvariantError(
    "parameter hapus komentar tidak sesuai tipe",
  ),
